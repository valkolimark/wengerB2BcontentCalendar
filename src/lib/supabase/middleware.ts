 ...
 * unauthenticated users are redirected to /login; an authenticated user landing
 * on /login is sent to the app.
 */
export async function updateSession(request: NextRequest) {
  ...
  // IMPORTANT: getUser() revalidates the token against Supabase — don't trust
